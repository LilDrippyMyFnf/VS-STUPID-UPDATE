...
HXLINE( 322)		 ::flixel::math::FlxBasePoint this1 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
HXDLIN( 322)		this->spawnScale = this1;
HXLINE( 321)		 ::flixel::math::FlxBasePoint this11 =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
HXDLIN( 321)		this->spawnPos = this11;
...
HXLINE( 420)			 ::flixel::math::FlxBasePoint this1 = this->offset;
HXDLIN( 420)			Float y = this->offset->y;
HXDLIN( 420)			this1->set_y((y + -((( (Float)(110) ) - this->get_height()))));
            		}
            	}
