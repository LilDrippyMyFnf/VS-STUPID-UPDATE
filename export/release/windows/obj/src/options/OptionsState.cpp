...
static const ::String _hx_array_data_14992103_1[] = {
	HX_("Note Colors",1e,54,23,f8),HX_("Controls",96,42,6e,11),HX_("Adjust Delay and Combo",b7,c9,c3,05),HX_("Graphics",eb,b4,19,ec),HX_("Visuals and UI",ea,4a,1e,90),HX_("Gameplay",06,bf,58,a5),HX_("Modes",90,93,85,9f),
};
...
HX_LOCAL_STACK_FRAME(_hx_pos_bddb8806f8971119_94_closeSubState,"options.OptionsState","closeSubState",0xbc3ad39e,"options.OptionsState.closeSubState","options/OptionsState.hx",94,0xaa608eba)
HX_LOCAL_STACK_FRAME(_hx_pos_bddb8806f8971119_99_update,"options.OptionsState","update",0xccb53214,"options.OptionsState.update","options/OptionsState.hx",99,0xaa608eba)
...
HXDLIN(  44)			goto _hx_goto_2;
            		...
            		if (  (_hx_switch_0==HX_("Modes",90,93,85,9f)) ){
HXLINE(  52)			this->openSubState( ::options::ModesShit_obj::__alloc( HX_CTX ));
...
HXDLIN(  64)		 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(HX_("menuDesat",26,91,04,72),library);
HXDLIN(  64)		 ::flixel::FlxSprite bg1 = bg->loadGraphic(returnAsset,null(),null(),null(),null(),null());
HXLINE(  65)		bg1->set_color(-1412611);
HXLINE(  66)		bg1->updateHitbox();
HXLINE(  68)		{
HXLINE(  68)			int axes = 17;
HXDLIN(  68)			bool _hx_tmp;
HXDLIN(  68)			if ((axes != 1)) {
HXLINE(  68)				_hx_tmp = (axes == 17);
            			}
            			else {
...
HXDLIN(  68)				bg1->set_x(((( (Float)(_hx_tmp) ) - bg1->get_width()) / ( (Float)(2) )));
            			}
...
HXDLIN(  68)				bg1->set_y(((( (Float)(_hx_tmp) ) - bg1->get_height()) / ( (Float)(2) )));
            			}
            		}
HXLINE(  69)		bg1->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
...
HXLINE(  77)				 ::Alphabet optionText =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),this->options->__get(i),true);
HXLINE(  78)				{
...
HXDLIN(  78)						optionText->set_x(((( (Float)(_hx_tmp) ) - optionText->get_width()) / ( (Float)(2) )));
            					}
...
HXDLIN(  78)						optionText->set_y(((( (Float)(_hx_tmp) ) - optionText->get_height()) / ( (Float)(2) )));
            					}
            				}
...
HXLINE(  83)		this->selectorLeft =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_(">",3e,00,00,00),true);
HXLINE(  84)		this->add(this->selectorLeft);
HXLINE(  85)		this->selectorRight =  ::Alphabet_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ),HX_("<",3c,00,00,00),true);
...
void OptionsState_obj::closeSubState(){
            	HX_STACKFRAME(&_hx_pos_bddb8806f8971119_94_closeSubState)
HXLINE(  95)		this->super::closeSubState();
HXLINE(  96)		::ClientPrefs_obj::saveSettings();
            	}


void OptionsState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_bddb8806f8971119_99_update)
HXLINE( 100)		this->super::update(elapsed);
HXLINE( 102)		if (::PlayerSettings_obj::player1->controls->_ui_upP->check()) {
HXLINE( 103)			this->changeSelection(-1);
            		}
HXLINE( 105)		if (::PlayerSettings_obj::player1->controls->_ui_downP->check()) {
...
HXDLIN( 110)			_hx_tmp->play(::Paths_obj::sound(HX_("cancelMenu",39,a4,43,b7),null()),null(),null(),null(),null(),null());
