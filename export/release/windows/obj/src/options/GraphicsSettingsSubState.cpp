...
HX_LOCAL_STACK_FRAME(_hx_pos_0d30d54fdd7b0ca4_90_onChangeAntiAliasing,"options.GraphicsSettingsSubState","onChangeAntiAliasing",0x62f8a1e2,"options.GraphicsSettingsSubState.onChangeAntiAliasing","options/GraphicsSettingsSubState.hx",90,0x60b97b2e)
HX_LOCAL_STACK_FRAME(_hx_pos_0d30d54fdd7b0ca4_102_onChangeFramerate,"options.GraphicsSettingsSubState","onChangeFramerate",0x9c8ce9ff,"options.GraphicsSettingsSubState.onChangeFramerate","options/GraphicsSettingsSubState.hx",102,0x60b97b2e)
namespace options{
...
HXLINE(  77)		 ::options::Option option4 =  ::options::Option_obj::__alloc( HX_CTX ,HX_("Vs Stupid v2 Vanilla assets",46,2a,dc,28),HX_("This will enable some v2 features \n( DONT USE CUZ ITS BETA AND ITS USELESS )",88,3d,0a,9d),HX_("vanillaV2",57,25,09,38),HX_("bool",2a,84,1b,41),false,null());
HXLINE(  82)		this->addOption(option4);
...
void GraphicsSettingsSubState_obj::onChangeAntiAliasing(){
            	HX_STACKFRAME(&_hx_pos_0d30d54fdd7b0ca4_90_onChangeAntiAliasing)
HXDLIN(  90)		int _g = 0;
HXDLIN(  90)		::Array< ::Dynamic> _g1 = this->members;
HXDLIN(  90)		while((_g < _g1->length)){
HXDLIN(  90)			 ::flixel::FlxBasic sprite = _g1->__get(_g).StaticCast<  ::flixel::FlxBasic >();
HXDLIN(  90)			_g = (_g + 1);
HXLINE(  92)			 ::Dynamic sprite1 = sprite;
HXLINE(  93)			 ::flixel::FlxSprite sprite2 = ( ( ::flixel::FlxSprite)(sprite1) );
HXLINE(  94)			bool _hx_tmp;
HXDLIN(  94)			bool _hx_tmp1;
HXDLIN(  94)			if (::hx::IsNotNull( sprite2 )) {
HXLINE(  94)				_hx_tmp1 = ::Std_obj::isOfType(sprite2,::hx::ClassOf< ::flixel::FlxSprite >());
            			}
            			else {
HXLINE(  94)				_hx_tmp1 = false;
            			}
HXDLIN(  94)			if (_hx_tmp1) {
HXLINE(  94)				_hx_tmp = !(::Std_obj::isOfType(sprite2,::hx::ClassOf< ::flixel::text::FlxText >()));
            			}
            			else {
HXLINE(  94)				_hx_tmp = false;
            			}
HXDLIN(  94)			if (_hx_tmp) {
HXLINE(  95)				sprite2->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            			}
            		}
            	}
...
void GraphicsSettingsSubState_obj::onChangeFramerate(){
            	HX_STACKFRAME(&_hx_pos_0d30d54fdd7b0ca4_102_onChangeFramerate)
HXDLIN( 102)		if ((::ClientPrefs_obj::framerate > ::flixel::FlxG_obj::drawFramerate)) {
HXLINE( 104)			::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
HXLINE( 105)			::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
            		}
            		else {
HXLINE( 109)			::flixel::FlxG_obj::set_drawFramerate(::ClientPrefs_obj::framerate);
HXLINE( 110)			::flixel::FlxG_obj::set_updateFramerate(::ClientPrefs_obj::framerate);
            		}
            	}
