...
HXLINE( 139)			 ::flixel::math::FlxBasePoint this1 = this->origin;
HXDLIN( 139)			Float y = (( (Float)(this->frameHeight) ) * ((Float)0.5));
HXDLIN( 139)			this1->set_x((( (Float)(this->frameWidth) ) * ((Float)0.5)));
HXDLIN( 139)			this1->set_y(y);
            		}
...
HXLINE( 148)		{
HXLINE( 148)			 ::flixel::math::FlxBasePoint this1 = this->origin;
HXDLIN( 148)			Float y = (( (Float)(this->frameHeight) ) * ((Float)0.5));
HXDLIN( 148)			this1->set_x((( (Float)(this->frameWidth) ) * ((Float)0.5)));
...
HXDLIN( 154)			if ((this->noteData > -1)) {
HXLINE( 154)				_hx_tmp = (this->noteData < ::ClientPrefs_obj::arrowHSV->length);
            			}
            			else {
HXLINE( 154)				_hx_tmp = false;
            			}
HXDLIN( 154)			if (_hx_tmp) {
HXLINE( 156)				this->colorSwap->set_hue((( (Float)(::ClientPrefs_obj::arrowHSV->__get(this->noteData).StaticCast< ::Array< int > >()->__get(0)) ) / ( (Float)(360) )));
HXLINE( 157)				this->colorSwap->set_saturation((( (Float)(::ClientPrefs_obj::arrowHSV->__get(this->noteData).StaticCast< ::Array< int > >()->__get(1)) ) / ( (Float)(100) )));
HXLINE( 158)				this->colorSwap->set_brightness((( (Float)(::ClientPrefs_obj::arrowHSV->__get(this->noteData).StaticCast< ::Array< int > >()->__get(2)) ) / ( (Float)(100) )));
            			}
HXLINE( 161)			bool _hx_tmp1;
HXDLIN( 161)			if ((this->animation->_curAnim->name == HX_("confirm",00,9d,39,10))) {
HXLINE( 161)				_hx_tmp1 = !(::PlayState_obj::isPixelStage);
            			}
            			else {
