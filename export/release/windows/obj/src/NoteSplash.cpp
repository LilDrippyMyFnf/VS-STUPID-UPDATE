...
HX_DEFINE_STACK_FRAME(_hx_pos_fc43ca8ee61f3046_6_new,"NoteSplash","new",0xb1e3348b,"NoteSplash.new","NoteSplash.hx",6,0x3ec9e545)
HX_LOCAL_STACK_FRAME(_hx_pos_fc43ca8ee61f3046_27_setupNoteSplash,"NoteSplash","setupNoteSplash",0x4d379881,"NoteSplash.setupNoteSplash","NoteSplash.hx",27,0x3ec9e545)
HX_LOCAL_STACK_FRAME(_hx_pos_fc43ca8ee61f3046_49_loadAnims,"NoteSplash","loadAnims",0x63686ba7,"NoteSplash.loadAnims","NoteSplash.hx",49,0x3ec9e545)
HX_LOCAL_STACK_FRAME(_hx_pos_fc43ca8ee61f3046_59_update,"NoteSplash","update",0x2e98cebe,"NoteSplash.update","NoteSplash.hx",59,0x3ec9e545)
...
void NoteSplash_obj::__construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y, ::Dynamic __o_note){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_fc43ca8ee61f3046_6_new)
HXLINE(  10)		this->textureLoaded = null();
HXLINE(   8)		this->colorSwap = null();
HXLINE(  13)		super::__construct(x,y,null());
HXLINE(  15)		::String skin = HX_("noteSplashes",a7,57,29,8d);
HXLINE(  16)		bool _hx_tmp;
HXDLIN(  16)		if (::hx::IsNotNull( ::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic) )) {
HXLINE(  16)			_hx_tmp = (( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) ).length > 0);
            		}
            		else {
HXLINE(  16)			_hx_tmp = false;
            		}
HXDLIN(  16)		if (_hx_tmp) {
HXLINE(  16)			skin = ( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) );
            		}
HXLINE(  18)		this->loadAnims(skin);
HXLINE(  20)		this->colorSwap =  ::ColorSwap_obj::__alloc( HX_CTX );
HXLINE(  21)		this->shader = this->colorSwap->shader;
HXLINE(  23)		this->setupNoteSplash(x,y,note,null(),null(),null(),null());
HXLINE(  24)		this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            	}
...
void NoteSplash_obj::setupNoteSplash(Float x,Float y,::hx::Null< int >  __o_note,::String texture,::hx::Null< Float >  __o_hueColor,::hx::Null< Float >  __o_satColor,::hx::Null< Float >  __o_brtColor){
            	...
            	HX_STACKFRAME(&_hx_pos_fc43ca8ee61f3046_27_setupNoteSplash)
HXLINE(  28)		this->setPosition((x - (::Note_obj::swagWidth * ((Float)0.95))),(y - ::Note_obj::swagWidth));
HXLINE(  29)		this->set_alpha(((Float)0.6));
HXLINE(  31)		if (::hx::IsNull( texture )) {
HXLINE(  32)			texture = HX_("noteSplashes",a7,57,29,8d);
HXLINE(  33)			bool _hx_tmp;
HXDLIN(  33)			if (::hx::IsNotNull( ::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic) )) {
HXLINE(  33)				_hx_tmp = (( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) ).length > 0);
            			}
            			else {
HXLINE(  33)				_hx_tmp = false;
            			}
HXDLIN(  33)			if (_hx_tmp) {
HXLINE(  33)				texture = ( (::String)(::PlayState_obj::SONG->__Field(HX_("splashSkin",84,03,e1,a1),::hx::paccDynamic)) );
            			}
            		}
HXLINE(  36)		if ((this->textureLoaded != texture)) {
HXLINE(  37)			this->loadAnims(texture);
            		}
...
HXDLIN(  42)			this1->set_x(( (Float)(10) ));
HXDLIN(  42)			this1->set_y(( (Float)(10) ));
            		}
HXLINE(  44)		int animNum = ::flixel::FlxG_obj::random->_hx_int(1,2,null());
HXLINE(  45)		this->animation->play((((HX_("note",f2,17,0a,49) + note) + HX_("-",2d,00,00,00)) + animNum),true,null(),null());
HXLINE(  46)		if (::hx::IsNotNull( this->animation->_curAnim )) {
HXLINE(  46)			 ::flixel::animation::FlxAnimation _hx_tmp = this->animation->_curAnim;
HXDLIN(  46)			_hx_tmp->set_frameRate(( (Float)((24 + ::flixel::FlxG_obj::random->_hx_int(-2,2,null()))) ));
            		}
            	}
...
void NoteSplash_obj::loadAnims(::String skin){
            	HX_STACKFRAME(&_hx_pos_fc43ca8ee61f3046_49_loadAnims)
HXLINE(  50)		::String library = null();
HXDLIN(  50)		 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(skin,null());
HXDLIN(  50)		bool xmlExists = false;
HXDLIN(  50)		if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e))))) {
...
HXLINE(  50)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(skin,library);
HXDLIN(  50)			_hx_tmp = returnAsset;
            		}
HXDLIN(  50)		::String _hx_tmp1;
HXDLIN(  50)		if (xmlExists) {
HXLINE(  50)			_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e))));
            		}
            		else {
HXLINE(  50)			_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + skin) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            		}
HXDLIN(  50)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE(  51)		{
HXLINE(  51)			{
HXLINE(  52)				this->animation->addByPrefix((HX_("note1-",4e,a3,b5,31) + 1),(HX_("note splash blue ",bb,a1,1a,b9) + 1),24,false,null(),null());
HXLINE(  53)				this->animation->addByPrefix((HX_("note2-",2d,a4,b5,31) + 1),(HX_("note splash green ",e8,04,d0,a7) + 1),24,false,null(),null());
HXLINE(  54)				this->animation->addByPrefix((HX_("note0-",6f,a2,b5,31) + 1),(HX_("note splash purple ",19,23,01,5b) + 1),24,false,null(),null());
HXLINE(  55)				this->animation->addByPrefix((HX_("note3-",0c,a5,b5,31) + 1),(HX_("note splash red ",da,d5,64,cd) + 1),24,false,null(),null());
            			}
HXLINE(  51)			{
HXLINE(  52)				this->animation->addByPrefix((HX_("note1-",4e,a3,b5,31) + 2),(HX_("note splash blue ",bb,a1,1a,b9) + 2),24,false,null(),null());
HXLINE(  53)				this->animation->addByPrefix((HX_("note2-",2d,a4,b5,31) + 2),(HX_("note splash green ",e8,04,d0,a7) + 2),24,false,null(),null());
HXLINE(  54)				this->animation->addByPrefix((HX_("note0-",6f,a2,b5,31) + 2),(HX_("note splash purple ",19,23,01,5b) + 2),24,false,null(),null());
HXLINE(  55)				this->animation->addByPrefix((HX_("note3-",0c,a5,b5,31) + 2),(HX_("note splash red ",da,d5,64,cd) + 2),24,false,null(),null());
            			}
            		}
            	}
...
void NoteSplash_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_fc43ca8ee61f3046_59_update)
HXLINE(  60)		if (::hx::IsNotNull( this->animation->_curAnim )) {
