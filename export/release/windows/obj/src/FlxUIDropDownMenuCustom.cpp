...
HXLINE( 367)		::Array< ::Dynamic> base = t->labelOffsets;
HXDLIN( 367)		base->__get(2).StaticCast<  ::flixel::math::FlxBasePoint >()->set_y((base->__get(2).StaticCast<  ::flixel::math::FlxBasePoint >()->y - ( (Float)(1) )));
...
HXLINE( 379)				 ::flixel::math::FlxBasePoint offset = _g2->__get(_g1).StaticCast<  ::flixel::math::FlxBasePoint >();
