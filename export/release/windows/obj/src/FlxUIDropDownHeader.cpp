...
HXLINE( 598)		 ::flixel::addons::ui::FlxUISpriteButton fh = this->button;
HXDLIN( 598)		fh->offset->set_x((fh->offset->x - ( (Float)((Width - this->button->frameWidth)) )));
HXLINE( 599)		this->button->set_x(this->offset->x);
HXLINE( 600)		 ::flixel::FlxSprite fh1 = ( ( ::flixel::FlxSprite)(this->button->label) );
HXDLIN( 600)		fh1->offset->set_x((fh1->offset->x + this->button->offset->x));
