...
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_49_onLoadJson,"Song","onLoadJson",0xe02d2786,"Song.onLoadJson","Song.hx",49,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_89_loadFromJson,"Song","loadFromJson",0x10fda511,"Song.loadFromJson","Song.hx",89,0x775e99e9)
HX_LOCAL_STACK_FRAME(_hx_pos_4e288e2989890fc6_125_parseJSONshit,"Song","parseJSONshit",0x7c7ff6e2,"Song.parseJSONshit","Song.hx",125,0x775e99e9)

void Song_obj::__construct(::String song,::Array< ::Dynamic> notes,Float bpm){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_33_new)
HXLINE(  46)		this->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  45)		this->player2 = HX_("dad",47,36,4c,00);
HXLINE(  44)		this->player1 = HX_("bf",c4,55,00,00);
HXLINE(  42)		this->speed = ((Float)1);
HXLINE(  39)		this->needsVoices = true;
HXLINE(  83)		this->song = song;
HXLINE(  84)		this->notes = notes;
HXLINE(  85)		this->bpm = bpm;
            	}
...
void Song_obj::onLoadJson( ::Dynamic songJson){
            	HX_STACKFRAME(&_hx_pos_4e288e2989890fc6_49_onLoadJson)
HXLINE(  50)		if (::hx::IsNull( songJson->__Field(HX_("gfVersion",b9,c6,7d,f3),::hx::paccDynamic) )) {
HXLINE(  52)			songJson->__SetField(HX_("gfVersion",b9,c6,7d,f3),songJson->__Field(HX_("player3",b2,09,15,8a),::hx::paccDynamic),::hx::paccDynamic);
HXLINE(  53)			songJson->__SetField(HX_("player3",b2,09,15,8a),null(),::hx::paccDynamic);
            		}
HXLINE(  56)		if (::hx::IsNull( songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic) )) {
HXLINE(  58)			songJson->__SetField(HX_("events",19,4f,6a,96),::cpp::VirtualArray_obj::__new(0),::hx::paccDynamic);
HXLINE(  59)			{
HXLINE(  59)				int _g = 0;
HXDLIN(  59)				int _g1 = ( (int)( ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic)) );
HXDLIN(  59)				while((_g < _g1)){
HXLINE(  59)					_g = (_g + 1);
HXDLIN(  59)					int secNum = (_g - 1);
HXLINE(  61)					 ::Dynamic sec =  ::Dynamic(songJson->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic))->__GetItem(secNum);
HXLINE(  63)					int i = 0;
HXLINE(  64)					::cpp::VirtualArray notes = ( (::cpp::VirtualArray)(sec->__Field(HX_("sectionNotes",1c,c8,a7,fe),::hx::paccDynamic)) );
HXLINE(  65)					int len = notes->get_length();
HXLINE(  66)					while((i < len)){
HXLINE(  68)						::cpp::VirtualArray note = ( (::cpp::VirtualArray)(notes->__get(i)) );
HXLINE(  69)						if (::hx::IsLess( note->__get(1),0 )) {
HXLINE(  71)							 ::Dynamic(songJson->__Field(HX_("events",19,4f,6a,96),::hx::paccDynamic))->__Field(HX_("push",da,11,61,4a),::hx::paccDynamic)(::Array_obj< ::Dynamic>::__new(2)->init(0,note->__get(0))->init(1,::Array_obj< ::Dynamic>::__new(1)->init(0,::cpp::VirtualArray_obj::__new(3)->init(0,note->__get(2))->init(1,note->__get(3))->init(2,note->__get(4)))));
HXLINE(  72)							notes->remove(note);
HXLINE(  73)							len = notes->get_length();
            						}
            						else {
HXLINE(  75)							i = (i + 1);
            						}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Song_obj,onLoadJson,(void))
 ...
 ::Dynamic Song_obj::loadFromJson(::String jsonInput,::String folder){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_89_loadFromJson)
HXLINE(  90)		::String rawJson = null();
HXLINE(  92)		 ::EReg invalidChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\;:<>#]",7e,4d,88,67),HX_("",00,00,00,00));
HXDLIN(  92)		 ::EReg hideChars =  ::EReg_obj::__alloc( HX_CTX ,HX_("[.,'\"%?!]",ca,d9,c0,ac),HX_("",00,00,00,00));
HXDLIN(  92)		::String path = invalidChars->split(::StringTools_obj::replace(folder,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)))->join(HX_("-",2d,00,00,00));
HXDLIN(  92)		::String formattedFolder = hideChars->split(path)->join(HX_("",00,00,00,00)).toLowerCase();
HXLINE(  93)		 ::EReg invalidChars1 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[~&\\\\;:<>#]",7e,4d,88,67),HX_("",00,00,00,00));
HXDLIN(  93)		 ::EReg hideChars1 =  ::EReg_obj::__alloc( HX_CTX ,HX_("[.,'\"%?!]",ca,d9,c0,ac),HX_("",00,00,00,00));
HXDLIN(  93)		::String path1 = invalidChars1->split(::StringTools_obj::replace(jsonInput,HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)))->join(HX_("-",2d,00,00,00));
HXDLIN(  93)		::String formattedSong = hideChars1->split(path1)->join(HX_("",00,00,00,00)).toLowerCase();
HXLINE(  95)		::String moddyFile = ::Paths_obj::modFolders(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)));
HXLINE(  96)		if (::sys::FileSystem_obj::exists(moddyFile)) {
HXLINE(  97)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(moddyFile));
            		}
HXLINE( 101)		if (::hx::IsNull( rawJson )) {
HXLINE( 103)			::String library = null();
HXDLIN( 103)			rawJson = ::StringTools_obj::trim(::sys::io::File_obj::getContent(::Paths_obj::getPath(((HX_("data/",c5,0e,88,d4) + ((formattedFolder + HX_("/",2f,00,00,00)) + formattedSong)) + HX_(".json",56,f1,d6,c2)),HX_("TEXT",ad,94,ba,37),library)));
            		}
HXLINE( 109)		if (::hx::IsNull( rawJson )) {
HXLINE( 110)			HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Could not find JSON file in: ",32,84,fd,6a) + formattedFolder)));
            		}
HXLINE( 112)		if (::hx::IsNotNull( rawJson )) {
HXLINE( 113)			while(!(::StringTools_obj::endsWith(rawJson,HX_("}",7d,00,00,00)))){
HXLINE( 114)				rawJson = rawJson.substr(0,(rawJson.length - 1));
            			}
            		}
HXLINE( 117)		 ::Dynamic songJson = ::Song_obj::parseJSONshit(rawJson);
HXLINE( 118)		if ((jsonInput != HX_("events",19,4f,6a,96))) {
HXLINE( 118)			::StageData_obj::loadDirectory(songJson);
            		}
HXLINE( 119)		::Song_obj::onLoadJson(songJson);
HXLINE( 120)		return songJson;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Song_obj,loadFromJson,return )
 ...
 ::Dynamic Song_obj::parseJSONshit(::String rawJson){
            	HX_GC_STACKFRAME(&_hx_pos_4e288e2989890fc6_125_parseJSONshit)
HXDLIN( 125)		return  ::haxe::format::JsonParser_obj::__alloc( HX_CTX ,rawJson)->doParse()->__Field(HX_("song",d5,23,58,4c),::hx::paccDynamic);
            	}
