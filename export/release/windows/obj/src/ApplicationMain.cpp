...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Vs Stupid",9a,ee,36,09),::ApplicationMain_obj::create_dyn());
...
HXLINE(  38)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("1210",00,90,89,20));
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("MyFnf",f2,f9,0a,a6));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Vs Stupid",9a,ee,36,09));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Vs Stupid: Demo Build",31,dc,ae,b6));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.myfnf.vsstupid",5d,e6,57,8a));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Vs Stupid: Demo Build",31,dc,ae,b6))
