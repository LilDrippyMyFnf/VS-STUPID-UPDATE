...
HX_LOCAL_STACK_FRAME(_hx_pos_6f429363a5b435b7_79_onVLCError,"vlc.MP4Handler","onVLCError",0xafb9d58e,"vlc.MP4Handler.onVLCError","vlc/MP4Handler.hx",79,0xe9b617a3)
...
HXLINE(  72)		::haxe::Log_obj::trace(HX_("Video loaded!",b7,d7,5b,40),::hx::SourceInfo(HX_("source/vlc/MP4Handler.hx",2f,f6,9c,2c),72,HX_("vlc.MP4Handler",ba,ee,54,31),HX_("onVLCVideoReady",16,c0,82,a6)));
...
void MP4Handler_obj::onVLCError(){
            	HX_STACKFRAME(&_hx_pos_6f429363a5b435b7_79_onVLCError)
HXLINE(  80)		::openfl::Lib_obj::get_application()->_hx___window->alert(HX_("Error occurred with VLC video",31,3f,2e,c2),HX_("VLC Error!",ec,1e,8f,e9));
HXLINE(  81)		this->finishVideo();
            	}
