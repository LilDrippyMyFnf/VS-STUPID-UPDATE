...
HXLINE(  64)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_fontybot_ttf >());
HXLINE(  65)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_phantommuff_ttf >());
HXLINE(  66)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_pixel_otf >());
HXLINE(  67)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_thefontever_ttf >());
HXLINE(  68)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_vcr_ttf >());
HXLINE(  69)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_nokiafc22_ttf >());
HXLINE(  70)		::openfl::text::Font_obj::registerFont(::hx::ClassOf< ::__ASSET__OPENFL__flixel_fonts_monsterrat_ttf >());
HXLINE(  74)		 ::Dynamic data;
HXDLIN(  74)		 ::Dynamic manifest;
HXDLIN(  74)		 ::Dynamic bundle;
HXLINE(  87)		{
HXLINE(  87)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/videos.json",1e,f9,65,67));
HXDLIN(  87)			::lime::utils::Assets_obj::libraryPaths->set(HX_("videos",98,d7,95,e5),v);
            		}
HXLINE(  88)		{
HXLINE(  88)			::String v1 = (::ManifestResources_obj::rootPath + HX_("manifest/songs.json",38,27,75,ee));
HXDLIN(  88)			::lime::utils::Assets_obj::libraryPaths->set(HX_("songs",fe,36,c7,80),v1);
            		}
HXLINE(  89)		{
HXLINE(  89)			::String v2 = (::ManifestResources_obj::rootPath + HX_("manifest/shared.json",f1,c2,0a,f4));
HXDLIN(  89)			::lime::utils::Assets_obj::libraryPaths->set(HX_("shared",a5,5e,2b,1d),v2);
            		}
HXLINE(  90)		{
HXLINE(  90)			::String v3 = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  90)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v3);
            		}
HXLINE(  74)		 ::lime::utils::AssetLibrary library = ::lime::utils::Assets_obj::getLibrary(HX_("videos",98,d7,95,e5));
HXLINE(  94)		if (::hx::IsNotNull( library )) {
HXLINE(  94)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  95)			::ManifestResources_obj::preloadLibraryNames->push(HX_("videos",98,d7,95,e5));
            		}
HXLINE(  96)		library = ::lime::utils::Assets_obj::getLibrary(HX_("songs",fe,36,c7,80));
HXLINE(  97)		if (::hx::IsNotNull( library )) {
HXLINE(  97)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  98)			::ManifestResources_obj::preloadLibraryNames->push(HX_("songs",fe,36,c7,80));
            		}
HXLINE(  99)		library = ::lime::utils::Assets_obj::getLibrary(HX_("shared",a5,5e,2b,1d));
HXLINE( 100)		if (::hx::IsNotNull( library )) {
HXLINE( 100)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 101)			::ManifestResources_obj::preloadLibraryNames->push(HX_("shared",a5,5e,2b,1d));
            		}
HXLINE( 102)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE( 103)		if (::hx::IsNotNull( library )) {
HXLINE( 103)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE( 104)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
