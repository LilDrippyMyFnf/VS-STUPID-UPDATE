...
HX_DEFINE_STACK_FRAME(_hx_pos_42903921f08af638_3406_new,"HScript","new",0x62027ee5,"HScript.new","FunkinLua.hx",3406,0x00117937)
HX_DEFINE_STACK_FRAME(_hx_pos_42903921f08af638_3373_new,"HScript","new",0x62027ee5,"HScript.new","FunkinLua.hx",3373,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_42903921f08af638_3369_get_variables,"HScript","get_variables",0xeb689d53,"HScript.get_variables","FunkinLua.hx",3369,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_42903921f08af638_3417_execute,"HScript","execute",0xe9f5df3a,"HScript.execute","FunkinLua.hx",3417,0x00117937)
HX_LOCAL_STACK_FRAME(_hx_pos_42903921f08af638_3362_boot,"HScript","boot",0x58458a0d,"HScript.boot","FunkinLua.hx",3362,0x00117937)
...
HXLINE(3397)			::PlayState_obj::instance->variables->set(name,value);
            		}
...
HXLINE(3401)			 ::Dynamic result = null();
HXLINE(3402)			if (::PlayState_obj::instance->variables->exists(name)) {
HXLINE(3402)				result = ::PlayState_obj::instance->variables->get(name);
            			}
HXLINE(3403)			return result;
            		}
            		HX_END_LOCAL_FUNC1(return)

            		HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_2) HXARGC(1)
            		bool _hx_run(::String name){
            			HX_GC_STACKFRAME(&_hx_pos_42903921f08af638_3406_new)
HXLINE(3407)			if (::PlayState_obj::instance->variables->exists(name)) {
HXLINE(3409)				::PlayState_obj::instance->variables->remove(name);
...
HXLINE(3412)			return false;
            	...
            	HX_GC_STACKFRAME(&_hx_pos_42903921f08af638_3373_new)
HXLINE(3374)		this->interp =  ::hscript::Interp_obj::__alloc( HX_CTX );
HXLINE(3375)		this->interp->variables->set(HX_("FlxG",b5,4b,97,2e),( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxG >()) ));
HXLINE(3376)		this->interp->variables->set(HX_("FlxSprite",f7,d5,84,45),( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxSprite >()) ));
HXLINE(3377)		this->interp->variables->set(HX_("FlxCamera",97,40,7b,39),( ( ::Dynamic)(::hx::ClassOf< ::flixel::FlxCamera >()) ));
HXLINE(3378)		this->interp->variables->set(HX_("FlxTimer",13,ca,0f,cd),( ( ::Dynamic)(::hx::ClassOf< ::flixel::util::FlxTimer >()) ));
HXLINE(3379)		this->interp->variables->set(HX_("FlxTween",b9,b4,4a,d6),( ( ::Dynamic)(::hx::ClassOf< ::flixel::tweens::FlxTween >()) ));
HXLINE(3380)		this->interp->variables->set(HX_("FlxEase",60,c5,64,d3),( ( ::Dynamic)(::hx::ClassOf< ::flixel::tweens::FlxEase >()) ));
HXLINE(3381)		this->interp->variables->set(HX_("PlayState",5d,83,c2,46),( ( ::Dynamic)(::hx::ClassOf< ::PlayState >()) ));
HXLINE(3382)		this->interp->variables->set(HX_("game",f2,f3,5e,44),::PlayState_obj::instance);
HXLINE(3383)		this->interp->variables->set(HX_("Paths",0e,7b,84,50),( ( ::Dynamic)(::hx::ClassOf< ::Paths >()) ));
HXLINE(3384)		this->interp->variables->set(HX_("Conductor",c7,77,a1,7b),( ( ::Dynamic)(::hx::ClassOf< ::Conductor >()) ));
HXLINE(3385)		this->interp->variables->set(HX_("ClientPrefs",c5,55,e0,8a),( ( ::Dynamic)(::hx::ClassOf< ::ClientPrefs >()) ));
HXLINE(3386)		this->interp->variables->set(HX_("Character",89,bb,a4,e3),( ( ::Dynamic)(::hx::ClassOf< ::Character >()) ));
HXLINE(3387)		this->interp->variables->set(HX_("Alphabet",d3,38,ea,fa),( ( ::Dynamic)(::hx::ClassOf< ::Alphabet >()) ));
HXLINE(3388)		this->interp->variables->set(HX_("CustomSubstate",82,cd,df,32),( ( ::Dynamic)(::hx::ClassOf< ::CustomSubstate >()) ));
HXLINE(3390)		this->interp->variables->set(HX_("FlxRuntimeShader",6b,22,33,11),( ( ::Dynamic)(::hx::ClassOf< ::flixel::addons::display::FlxRuntimeShader >()) ));
HXLINE(3392)		this->interp->variables->set(HX_("ShaderFilter",dd,08,30,bd),( ( ::Dynamic)(::hx::ClassOf< ::openfl::filters::ShaderFilter >()) ));
HXLINE(3393)		this->interp->variables->set(HX_("StringTools",6a,db,63,03),( ( ::Dynamic)(::hx::ClassOf< ::StringTools >()) ));
HXLINE(3395)		this->interp->variables->set(HX_("setVar",65,6c,71,6f), ::Dynamic(new _hx_Closure_0()));
HXLINE(3399)		this->interp->variables->set(HX_("getVar",f1,17,29,a3), ::Dynamic(new _hx_Closure_1()));
HXLINE(3405)		this->interp->variables->set(HX_("removeVar",03,fd,f4,ca), ::Dynamic(new _hx_Closure_2()));
            	}
...
bool HScript_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ds::StringMap HScript_obj::get_variables(){
            	HX_STACKFRAME(&_hx_pos_42903921f08af638_3369_get_variables)
HXDLIN(3369)		return this->interp->variables;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(HScript_obj,get_variables,return )
 ...
 ::Dynamic HScript_obj::execute(::String codeToRun){
            	HX_STACKFRAME(&_hx_pos_42903921f08af638_3417_execute)
HXLINE(3419)		::HScript_obj::parser->line = 1;
HXLINE(3420)		::HScript_obj::parser->allowTypes = true;
HXLINE(3421)		 ::hscript::Interp _hx_tmp = this->interp;
HXDLIN(3421)		return _hx_tmp->execute(::HScript_obj::parser->parseString(codeToRun,null()));
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_42903921f08af638_3362_boot)
HXDLIN(3362)		parser =  ::hscript::Parser_obj::__alloc( HX_CTX );
            	}
}
