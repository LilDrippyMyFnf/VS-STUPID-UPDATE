...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_24_update,"HealthIcon","update",0x767ac302,"HealthIcon.update","HealthIcon.hx",24,0xf7836789)
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_32_swapOldIcon,"HealthIcon","swapOldIcon",0xe3496dd4,"HealthIcon.swapOldIcon","HealthIcon.hx",32,0xf7836789)
...
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_62_updateHitbox,"HealthIcon","updateHitbox",0x4656523a,"HealthIcon.updateHitbox","HealthIcon.hx",62,0xf7836789)
HX_LOCAL_STACK_FRAME(_hx_pos_eb8a54c9c53eb75f_69_getCharacter,"HealthIcon","getCharacter",0x409335ec,"HealthIcon.getCharacter","HealthIcon.hx",69,0xf7836789)
...
HXLINE(  36)		this->iconOffsets = ::Array_obj< Float >::fromData( _hx_array_data_f8f9be55_1,2);
HXLINE(  12)		this->_hx_char = HX_("",00,00,00,00);
HXLINE(  11)		this->isPlayer = false;
HXLINE(  10)		this->isOldIcon = false;
HXLINE(  16)		super::__construct(null(),null(),null());
HXLINE(  17)		this->isOldIcon = (_hx_char == HX_("bf-old",5e,ba,eb,07));
HXLINE(  18)		this->isPlayer = isPlayer;
HXLINE(  19)		this->changeIcon(_hx_char);
HXLINE(  20)		{
HXLINE(  20)			 ::flixel::math::FlxBasePoint this1 = this->scrollFactor;
HXDLIN(  20)			this1->set_x(( (Float)(0) ));
HXDLIN(  20)			this1->set_y(( (Float)(0) ));
            		}
            	}
...
void HealthIcon_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_24_update)
HXLINE(  25)		this->super::update(elapsed);
HXLINE(  27)		if (::hx::IsNotNull( this->sprTracker )) {
HXLINE(  28)			Float _hx_tmp = this->sprTracker->x;
HXDLIN(  28)			Float _hx_tmp1 = ((_hx_tmp + this->sprTracker->get_width()) + 12);
HXDLIN(  28)			this->setPosition(_hx_tmp1,(this->sprTracker->y - ( (Float)(30) )));
            		}
            	}


void HealthIcon_obj::swapOldIcon(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_32_swapOldIcon)
HXDLIN(  32)		if ((this->isOldIcon = !(this->isOldIcon))) {
HXDLIN(  32)			this->changeIcon(HX_("bf-old",5e,ba,eb,07));
            		}
            		else {
HXLINE(  33)			this->changeIcon(HX_("bf",c4,55,00,00));
            		}
            	}
...
HXDLIN(  42)			 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(name,library);
HXDLIN(  42)			 ::Dynamic file = returnAsset;
HXLINE(  44)			this->loadGraphic(file,null(),null(),null(),null(),null());
HXLINE(  45)			int _hx_tmp4 = ::Math_obj::floor((this->get_width() / ( (Float)(2) )));
HXDLIN(  45)			this->loadGraphic(file,true,_hx_tmp4,::Math_obj::floor(this->get_height()),null(),null());
HXLINE(  46)			this->iconOffsets[0] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(2) ));
HXLINE(  47)			this->iconOffsets[1] = ((this->get_width() - ( (Float)(150) )) / ( (Float)(2) ));
HXLINE(  48)			this->updateHitbox();
HXLINE(  50)			this->animation->add(_hx_char,::Array_obj< int >::fromData( _hx_array_data_f8f9be55_5,2),0,false,this->isPlayer,null());
HXLINE(  51)			this->animation->play(_hx_char,null(),null(),null());
HXLINE(  52)			this->_hx_char = _hx_char;
HXLINE(  54)			this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
HXLINE(  55)			if (::StringTools_obj::endsWith(_hx_char,HX_("-pixel",39,03,b3,c0))) {
...
void HealthIcon_obj::updateHitbox(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_62_updateHitbox)
HXLINE(  63)		this->super::updateHitbox();
HXLINE(  64)		this->offset->set_x(this->iconOffsets->__get(0));
HXLINE(  65)		this->offset->set_y(this->iconOffsets->__get(1));
            	}


::String HealthIcon_obj::getCharacter(){
            	HX_STACKFRAME(&_hx_pos_eb8a54c9c53eb75f_69_getCharacter)
HXDLIN(  69)		return this->_hx_char;
            	}
