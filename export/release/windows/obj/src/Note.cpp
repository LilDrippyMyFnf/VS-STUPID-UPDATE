...
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_315_loadNoteAnims,"Note","loadNoteAnims",0x493f5f8e,"Note.loadNoteAnims","Note.hx",315,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_330_loadPixelNoteAnims,"Note","loadPixelNoteAnims",0xefd7042c,"Note.loadPixelNoteAnims","Note.hx",330,0x1a8855ec)
HX_LOCAL_STACK_FRAME(_hx_pos_3be6f1ff2d789e96_339_update,"Note","update",0xca3a1ee5,"Note.update","Note.hx",339,0x1a8855ec)
...
HXLINE( 175)			_hx_tmp = -278;
            		}
            		else {
HXLINE( 175)			_hx_tmp = 42;
            		}
...
HXDLIN( 297)			 ::flixel::graphics::FlxGraphic imageLoaded = ::Paths_obj::returnGraphic(blahblah,null());
HXDLIN( 297)			bool xmlExists = false;
HXDLIN( 297)			if (::sys::FileSystem_obj::exists(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))))) {
HXLINE( 297)				xmlExists = true;
            			}
HXDLIN( 297)			 ::Dynamic _hx_tmp;
HXDLIN( 297)			if (::hx::IsNotNull( imageLoaded )) {
HXLINE( 297)				_hx_tmp = imageLoaded;
            			}
            			else {
HXLINE( 297)				 ::flixel::graphics::FlxGraphic returnAsset = ::Paths_obj::returnGraphic(blahblah,library);
HXDLIN( 297)				_hx_tmp = returnAsset;
            			}
HXDLIN( 297)			::String _hx_tmp1;
HXDLIN( 297)			if (xmlExists) {
HXLINE( 297)				_hx_tmp1 = ::sys::io::File_obj::getContent(::Paths_obj::modFolders(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e))));
            			}
            			else {
HXLINE( 297)				_hx_tmp1 = ::Paths_obj::getPath(((HX_("images/",77,50,74,c1) + blahblah) + HX_(".xml",69,3e,c3,1e)),HX_("TEXT",ad,94,ba,37),library);
            			}
HXDLIN( 297)			this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(_hx_tmp,_hx_tmp1));
HXLINE( 298)			this->loadNoteAnims();
HXLINE( 299)			this->set_antialiasing(::ClientPrefs_obj::globalAntialiasing);
            		}
HXLINE( 301)		if (this->isSustainNote) {
HXLINE( 302)			this->scale->set_y(lastScaleY);
            		}
HXLINE( 304)		this->updateHitbox();
HXLINE( 306)		if (::hx::IsNotNull( animName )) {
HXLINE( 307)			this->animation->play(animName,true,null(),null());
            		}
HXLINE( 309)		if (this->inEditor) {
HXLINE( 310)			this->setGraphicSize(::editors::ChartingState_obj::GRID_SIZE,::editors::ChartingState_obj::GRID_SIZE);
...
void Note_obj::loadNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_315_loadNoteAnims)
HXLINE( 316)		this->animation->addByPrefix((this->colArray->__get(this->noteData) + HX_("Scroll",2d,4c,f9,7b)),(this->colArray->__get(this->noteData) + HX_("0",30,00,00,00)),null(),null(),null(),null());
...
HXLINE( 321)			this->animation->addByPrefix((this->colArray->__get(this->noteData) + HX_("holdend",fc,4b,02,b8)),(this->colArray->__get(this->noteData) + HX_(" hold end",9a,cc,8a,7a)),null(),null(),null(),null());
HXLINE( 322)			this->animation->addByPrefix((this->colArray->__get(this->noteData) + HX_("hold",3f,c9,12,45)),(this->colArray->__get(this->noteData) + HX_(" hold piece",6d,10,66,9e)),null(),null(),null(),null());
            		}
HXLINE( 325)		this->setGraphicSize(::Std_obj::_hx_int((this->get_width() * ((Float)0.7))),null());
HXLINE( 326)		this->updateHitbox();
            	}
...
void Note_obj::loadPixelNoteAnims(){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_330_loadPixelNoteAnims)
HXDLIN( 330)		if (this->isSustainNote) {
HXLINE( 331)			this->animation->add((this->colArray->__get(this->noteData) + HX_("holdend",fc,4b,02,b8)),::Array_obj< int >::__new(1)->init(0,(this->pixelInt->__get(this->noteData) + 4)),null(),null(),null(),null());
HXLINE( 332)			this->animation->add((this->colArray->__get(this->noteData) + HX_("hold",3f,c9,12,45)),::Array_obj< int >::__new(1)->init(0,this->pixelInt->__get(this->noteData)),null(),null(),null(),null());
            		}
            		else {
HXLINE( 334)			this->animation->add((this->colArray->__get(this->noteData) + HX_("Scroll",2d,4c,f9,7b)),::Array_obj< int >::__new(1)->init(0,(this->pixelInt->__get(this->noteData) + 4)),null(),null(),null(),null());
            		}
            	}
...
void Note_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_3be6f1ff2d789e96_339_update)
HXLINE( 340)		this->super::update(elapsed);
HXLINE( 342)		if (this->mustPress) {
HXLINE( 345)			bool _hx_tmp;
HXDLIN( 345)			if ((this->strumTime > (::Conductor_obj::songPosition - (::Conductor_obj::safeZoneOffset * this->lateHitMult)))) {
HXLINE( 345)				_hx_tmp = (this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)));
            			}
            			else {
HXLINE( 345)				_hx_tmp = false;
            			}
HXDLIN( 345)			if (_hx_tmp) {
HXLINE( 347)				this->canBeHit = true;
            			}
            			else {
HXLINE( 349)				this->canBeHit = false;
            			}
HXLINE( 351)			bool _hx_tmp1;
HXDLIN( 351)			if ((this->strumTime < (::Conductor_obj::songPosition - ::Conductor_obj::safeZoneOffset))) {
HXLINE( 351)				_hx_tmp1 = !(this->wasGoodHit);
            			}
            			else {
HXLINE( 351)				_hx_tmp1 = false;
            			}
HXDLIN( 351)			if (_hx_tmp1) {
HXLINE( 352)				this->tooLate = true;
            			}
            		}
            		else {
HXLINE( 356)			this->canBeHit = false;
HXLINE( 358)			if ((this->strumTime < (::Conductor_obj::songPosition + (::Conductor_obj::safeZoneOffset * this->earlyHitMult)))) {
HXLINE( 360)				bool _hx_tmp;
HXDLIN( 360)				bool _hx_tmp1;
HXDLIN( 360)				if (this->isSustainNote) {
HXLINE( 360)					_hx_tmp1 = this->prevNote->wasGoodHit;
            				}
            				else {
HXLINE( 360)					_hx_tmp1 = false;
            				}
HXDLIN( 360)				if (!(_hx_tmp1)) {
HXLINE( 360)					_hx_tmp = (this->strumTime <= ::Conductor_obj::songPosition);
            				}
            				else {
HXLINE( 360)					_hx_tmp = true;
            				}
HXDLIN( 360)				if (_hx_tmp) {
HXLINE( 361)					this->wasGoodHit = true;
            				}
            			}
            		}
HXLINE( 365)		bool _hx_tmp;
HXDLIN( 365)		if (this->tooLate) {
HXLINE( 365)			_hx_tmp = !(this->inEditor);
            		}
            		else {
HXLINE( 365)			_hx_tmp = false;
            		}
HXDLIN( 365)		if (_hx_tmp) {
HXLINE( 367)			if ((this->alpha > ((Float)0.3))) {
HXLINE( 368)				this->set_alpha(((Float)0.3));
            			}
            		}
            	}
