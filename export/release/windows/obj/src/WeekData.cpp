...
static const ::String _hx_array_data_0344a85e_15[] = {
...
HXLINE(  95)		::Array< ::String > directories = ::Array_obj< ::String >::fromData( _hx_array_data_0344a85e_15,2);
HXLINE(  96)		int originalLength = directories->length;
HXLINE(  97)		if (::sys::FileSystem_obj::exists(modsListPath)) {
HXLINE(  99)			::Array< ::String > stuff;
HXDLIN(  99)			if (::sys::FileSystem_obj::exists(modsListPath)) {
HXLINE(  99)				::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN(  99)				{
HXLINE(  99)					int _g1 = 0;
HXDLIN(  99)					::Array< ::String > _g2 = ::StringTools_obj::trim(::openfl::utils::Assets_obj::getText(modsListPath)).split(HX_("\n",0a,00,00,00));
HXDLIN(  99)					while((_g1 < _g2->length)){
HXLINE(  99)						::String i = _g2->__get(_g1);
HXDLIN(  99)						_g1 = (_g1 + 1);
HXDLIN(  99)						_g->push(::StringTools_obj::trim(i));
            					}
            				}
HXDLIN(  99)				stuff = _g;
            			}
            			else {
HXLINE(  99)				stuff = ::Array_obj< ::String >::__new(0);
            			}
HXLINE( 100)			{
HXLINE( 100)				int _g = 0;
...
HXDLIN( 135)		::String path = (HX_("assets/",4c,2a,dc,36) + file);
HXDLIN( 135)		::Array< ::String > sexList;
HXDLIN( 135)		if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 135)			::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 135)			{
HXLINE( 135)				int _g1 = 0;
HXDLIN( 135)				::Array< ::String > _g2 = ::StringTools_obj::trim(::openfl::utils::Assets_obj::getText(path)).split(HX_("\n",0a,00,00,00));
HXDLIN( 135)				while((_g1 < _g2->length)){
HXLINE( 135)					::String i = _g2->__get(_g1);
HXDLIN( 135)					_g1 = (_g1 + 1);
HXDLIN( 135)					_g->push(::StringTools_obj::trim(i));
            				}
            			}
HXDLIN( 135)			sexList = _g;
            		}
            		else {
HXLINE( 135)			sexList = ::Array_obj< ::String >::__new(0);
            		}
HXLINE( 136)		{
...
HXLINE( 163)					::String path = (directory + HX_("weekList.txt",74,12,92,5d));
HXDLIN( 163)					::Array< ::String > listOfWeeks;
HXDLIN( 163)					if (::sys::FileSystem_obj::exists(path)) {
HXLINE( 163)						::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 163)						{
HXLINE( 163)							int _g1 = 0;
HXDLIN( 163)							::Array< ::String > _g2 = ::StringTools_obj::trim(::openfl::utils::Assets_obj::getText(path)).split(HX_("\n",0a,00,00,00));
HXDLIN( 163)							while((_g1 < _g2->length)){
HXLINE( 163)								::String i = _g2->__get(_g1);
HXDLIN( 163)								_g1 = (_g1 + 1);
HXDLIN( 163)								_g->push(::StringTools_obj::trim(i));
            							}
            						}
HXDLIN( 163)						listOfWeeks = _g;
            					}
            					else {
HXLINE( 163)						listOfWeeks = ::Array_obj< ::String >::__new(0);
            					}
HXLINE( 164)					{
HXLINE( 164)						int _g = 0;
...
HXLINE( 253)			::Array< ::String > _this = ::StringTools_obj::trim(::sys::io::File_obj::getContent(HX_("modsList.txt",f1,ca,08,ac))).split(HX_("\n",0a,00,00,00));
HXDLIN( 253)			::Array< ::String > result = ::Array_obj< ::String >::__new(_this->length);
HXDLIN( 253)			{
HXLINE( 253)				int _g = 0;
HXDLIN( 253)				int _g1 = _this->length;
HXDLIN( 253)				while((_g < _g1)){
HXLINE( 253)					_g = (_g + 1);
HXDLIN( 253)					int i = (_g - 1);
HXDLIN( 253)					{
HXLINE( 253)						::String inValue = ::StringTools_obj::trim(( (::String)(_hx_array_unsafe_get(_this,i)) ));
HXDLIN( 253)						result->__unsafe_set(i,inValue);
            					}
            				}
            			}
HXDLIN( 253)			::Array< ::String > list = result;
HXLINE( 254)			bool foundTheTop = false;
HXLINE( 255)			{
HXLINE( 255)				int _g2 = 0;
HXDLIN( 255)				while((_g2 < list->length)){
HXLINE( 255)					::String i = list->__get(_g2);
