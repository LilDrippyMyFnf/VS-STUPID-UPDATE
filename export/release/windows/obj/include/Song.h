...
HX_DECLARE_STACK_FRAME(_hx_pos_4e288e2989890fc6_33_new)
...
HXLINE(  46)		( ( ::Song)(__this) )->gfVersion = HX_("gf",1f,5a,00,00);
HXLINE(  45)		( ( ::Song)(__this) )->player2 = HX_("dad",47,36,4c,00);
HXLINE(  44)		( ( ::Song)(__this) )->player1 = HX_("bf",c4,55,00,00);
HXLINE(  42)		( ( ::Song)(__this) )->speed = ((Float)1);
HXLINE(  39)		( ( ::Song)(__this) )->needsVoices = true;
HXLINE(  83)		( ( ::Song)(__this) )->song = song;
HXLINE(  84)		( ( ::Song)(__this) )->notes = notes;
HXLINE(  85)		( ( ::Song)(__this) )->bpm = bpm;
            	}
