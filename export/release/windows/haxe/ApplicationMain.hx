...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Vs Stupid", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Vs Stupid", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Vs Stupid";
		app.meta["name"] = "Vs Stupid: Demo Build";
		app.meta["packageName"] = "com.myfnf.vsstupid";
